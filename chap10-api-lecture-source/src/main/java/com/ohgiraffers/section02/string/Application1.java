...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 인덱스를 벗어난 정수를 인자로 전달하는 경우 IndexOutOfBoundsExeception이 발생한다.*/
        ...
        /*compareTO(0) : 인자로 전달된 문자열과 사전 순으로 비교를 하여
        ...
        * 단, 이 메소드는 대소문자를 구분하여 비교한다.*/
        ...
        System.out.println("comparaeToIgnoreCase() : " + (str3.compareToIgnoreCase(str4)));     //0
        ...
        *             단, 일치하는 문자가 없는경우 -1을 반환한다.*/
        String indexOf = "javaorcle";
        System.out.println("index('a') : " + indexOf.indexOf('a'));     //1
        System.out.println("index('b') : " + indexOf.indexOf('b'));     //-1
        ...
        * toUpperCase() : 모든 문자를 대문자로 변환시킨다.*/
        ...
        System.out.println("substring(3,6) : " + javamysql.substring(3));       //amysql
