...
public class Application {
    public static void main(String[] args) {
        ...
        * 유영ㄴ성 확보는 여러 곳에 적용될 수 있는 유연한 객체를 의미하며, 즉 재사용성이 높아질 수 있게 한다.
        * 객체의 재사용성이 증가하면 중복 작성되는 코드를 줄일 수 있으며, 오류발생 가능성을 감소시키고 유지보수성을 증가시킨다.*/
        ...
        * 5. 운전자가 엑셀을 밟으면 시동이 걸린 상태일 경우 자동차는 시속이 10km/h 증가하며 앞으로 나간다.
        * 6. 자동차가 달리는 중인 경우 브레이크를 밟으면 자동차으 시속은 0으로 떨어지며 멈춘다.
        ...
        *   1)CarDriver 클래스
        *       -속성 : 자동차(Car 클래스)
        *       -행위(기능) : 시동을 걸어라, 엑셀 밟아라, 브레이크 밟아라, 시동을 꺼라
        *   2)Car 클래스
        *       -속성 : 시동상태, 현재시속
        *       -행위(메소드) : 시동을 걸어라, 앞으로 가라, 멈춰라, 시동을꺼라*/
