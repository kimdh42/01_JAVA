...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 필기.
        * 비교 연산자
        * 비교 연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 혹은 거짓을 봔환하는 연산자이다.
        ...
        *  */
        ...
        System.out.println("imum1이 inum2보다 크거나 같은지 비교 : " + (inum1 >= inum2));
        System.out.println("imum1이 inum2보다 작거나 같은지 비교 : " + (inum1 <= inum2));
